...
export const studentCurriculum: StudentModule[] = [
  {
    ...
    introduction: 'Welcome to the Cyber Awareness Tool! Cybersecurity is like locking your house, but for your phone, computer, and online accounts. Before we dive into specific attacks, let\'s understand the basics.',
