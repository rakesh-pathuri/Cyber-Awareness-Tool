...
> **Project Goal:** Make cybersecurity education accessible, engaging, and hands-on by providing interactive threat simulations for students and powerful presentation tools for teachers.

## Overview

Cybersecurity training is often dry, theoretical, and difficult to grasp for non-technical audiences. Reading about a phishing attack or ransomware is fundamentally different from experiencing it firsthand.

Cyber Awareness Lab bridges this gap. It provides a safe, interactive sandbox where users can experience simulated cyber threats in real-time. By actively participating in scenarios—like spotting deepfakes, configuring secure passwords, or escaping a ransomware attack—students develop practical reflexes rather than just theoretical knowledge. The platform includes a dedicated Student Dashboard for self-paced learning and a Teacher Dashboard for classroom presentations.
